...
**Interactive tools:** [Sampling tool](tools/sampling/index.html) (Ch.2) · [Annotation tool](tools/annotation/index.html) (Ch.4) · [Cleaning workbench](tools/cleaning/index.html) (Ch.5) · [Bias & fairness meter](tools/fairness/index.html) (Ch.7) · [Datasheet builder](tools/datasheet/index.html) (Ch.8).
