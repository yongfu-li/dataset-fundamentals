/* Annotation tool — browser bounding-box labeling for Chapter 4.
...
(function () {
  ...
  function render() {
    root.innerHTML = [
      ...
      "then download an annotated dataset (images + PASCAL VOC + COCO JSON).</p>",
      ...
      const entries = [
        {
          name: "README.txt",
          data:
            "Annotated dataset from the Annotation tool (Chapter 4).\n" +
