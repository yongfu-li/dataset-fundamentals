...
**Live path:** `lectures/tools/image-annotation/index.html` (after `build_site.py`)

For text labeling (sentiment / NER spans), see
...
```bash
cd lectures/tools/image-annotation/data
