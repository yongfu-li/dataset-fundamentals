...
(function (global) {
  ...
  "justice-risk-score": {
    ...
    "context": "A county pilot proposes using a commercial 'flight risk' score built from prior arrests, age, and home ZIP to recommend detention vs release. Defense counsel was not in the design room. Historical arrest data over-represents some neighborhoods.",
    "bookAnchors": [
      "\u00a73.9",
      "sec:3.9",
      "eg:3.33",
    ...
    "nodes": {
      ...
      "outcome-revise-stakes": {
        ...
        "rationale": "Even 'advisory' scores shape decisions under time pressure. Treat the pilot as high-stakes until independent review says otherwise.",
        "lenses": [
          "rights-based",
          "virtue"
        ],
      ...
      "outcome-stop-contest": {
        ...
        "rationale": "A proprietary number that cannot be challenged fails rights-based and accountability tests for detention recommendations.",
        "lenses": [
          "rights-based",
          "accountability"
        ],
      ...
      "outcome-stop-bias-j": {
        ...
        "rationale": "Arrest history is not a neutral mirror of risk. Deploying without an audit risks laundering unequal enforcement into 'objective' scores.",
        "lenses": [
          "justice",
          "non-maleficence"
        ],
      ...
      "outcome-revise-pilot": {
        ...
        "rationale": "A non-binding shadow pilot can generate evidence without changing liberty outcomes until fairness and contestability are proven.",
        "lenses": [
          "utilitarian",
          "justice"
        ],
      ...
      "outcome-proceed-justice": {
        ...
        "rationale": "High stakes acknowledged, contestability exists, skew audited and mitigated, and overrides are logged \u2014 proceed only with continuous monitoring.",
        "lenses": [
          "accountability",
          "justice"
        ],
  ...
  "campus-cameras": {
    ...
    "context": "After a few theft reports, facilities proposes turning existing cameras into a live facial-matching system against student ID photos. Marketing later asks whether the same feed can measure 'foot traffic demographics' for vendors.",
    "bookAnchors": [
      "\u00a73.9",
      "\u00a73.10",
      "eg:3.35"
    ...
    "nodes": {
      ...
      "outcome-stop-nec": {
        ...
        "rationale": "'Cameras already exist' is not a justification for face matching. Rights-based and non-maleficence lenses require necessity first.",
        "lenses": [
          "rights-based",
          "non-maleficence"
        ],
      ...
      "outcome-stop-scope": {
        ...
        "rationale": "Leaving the door open to marketing demographics converts a safety claim into population surveillance without a matching ethical basis.",
        "lenses": [
          "purpose-limitation",
          "justice"
        ],
      ...
      "outcome-revise-notice": {
        ...
        "rationale": "Buried contract language is weak autonomy. People need to know they are biometrically matched and how to challenge errors.",
        "lenses": [
          "autonomy",
          "transparency"
        ],
      ...
      "outcome-proceed-campus": {
        ...
        "rationale": "Necessity documented, marketing reuse banned, notice and short retention in place, humans review matches \u2014 proceed with audit logging.",
        "lenses": [
          "utilitarian",
          "accountability"
        ],
  ...
  "scraped-social": {
    ...
    "context": "Researchers plan to scrape millions of public social posts, label toxicity with crowdworkers, and publish the dataset. Posts include usernames and sometimes photos of minors in the background. The platform ToS discourages bulk scraping.",
    "bookAnchors": [
      "\u00a73.9",
      "sec:3.9"
    ],
    ...
    "nodes": {
      ...
      "outcome-stop-public": {
        ...
        "rationale": "Visibility on a platform does not equal consent to bulk collection, toxicity labeling, and redistribution. Rights-based reasoning rejects that leap.",
        "lenses": [
          "rights-based",
          "autonomy"
        ],
      ...
      "outcome-stop-minors": {
        ...
        "rationale": "If minors cannot be reliably excluded, non-maleficence supports not building or releasing the corpus at this scale.",
        "lenses": [
          "non-maleficence",
          "justice"
        ],
      ...
      "outcome-revise-release": {
        ...
        "rationale": "Reproducibility does not require dumping handles and raw posts. Accountability can use gated access and hashed identifiers.",
        "lenses": [
          "non-maleficence",
          "accountability"
        ],
      ...
      "outcome-revise-workers": {
        ...
        "rationale": "Cheap labeling that harms workers fails virtue and justice even if the downstream model looks useful.",
        "lenses": [
          "virtue",
          "justice"
        ],
      ...
      "outcome-proceed-scrape": {
        ...
        "rationale": "Public-data myth rejected, minors controlled, release minimized, workers protected \u2014 proceed with documented limits and review.",
        "lenses": [
          "utilitarian",
          "accountability"
        ],
  ...
  "retention-delete": {
    ...
    "context": "A user exercises a deletion right on their account and uploaded photos. Engineering can wipe the production database, but last quarter\u2019s training export still contains their images, and a fine-tuned model may have memorized them.",
    "bookAnchors": [
      "\u00a73.9",
      "sec:3.9"
    ],
    ...
    "nodes": {
      ...
      "outcome-revise-scope": {
        ...
        "rationale": "Leaving training exports untouched after a deletion request fails rights-based and accountability expectations.",
        "lenses": [
          "rights-based",
          "accountability"
        ],
      ...
      "outcome-revise-comms": {
        ...
        "rationale": "Claiming deletion while artifacts remain misleads the user. Transparency requires stating residual copies and timelines.",
        "lenses": [
          "transparency",
          "virtue"
        ],
      ...
      "outcome-revise-residual": {
        ...
        "rationale": "When unlearning lags, ethics still requires stopping new training on the user and documenting residual memorization risk.",
        "lenses": [
          "non-maleficence",
          "accountability"
        ],
      ...
      "outcome-stop-ignore": {
        ...
        "rationale": "Cost alone does not erase the obligation. Continuing unchanged use after a valid deletion request fails autonomy and non-maleficence.",
        "lenses": [
          "rights-based",
          "non-maleficence"
        ],
      ...
      "outcome-proceed-delete": {
        ...
        "rationale": "Scope covers derived artifacts, purge is feasible, and communication is honest \u2014 proceed and verify completion.",
        "lenses": [
          "rights-based",
          "accountability"
        ],
  ...
  "smart-speaker": {
    ...
    "context": "A smart speaker already streams audio after the wake word. Engineering proposes keeping a rolling 10-second pre-roll buffer and uploading random clips for model training\u2014even when the wake word was not detected. Nighttime audio may capture private conversations.",
    "bookAnchors": [
      "\u00a73.9",
      "sec:3.9"
    ],
    ...
    "nodes": {
      ...
      "outcome-stop-expect": {
        ...
        "rationale": "Stretching 'product improvement' to cover always-on pre-roll uploads without user expectation fails autonomy and purpose limitation.",
        "lenses": [
          "autonomy",
          "purpose-limitation"
        ],
      ...
      "outcome-stop-force": {
        ...
        "rationale": "Making intimate audio capture the default is not freely given consent. Rights-based reasoning rejects forced participation.",
        "lenses": [
          "rights-based",
          "non-maleficence"
        ],
      ...
      "outcome-revise-speaker": {
        ...
        "rationale": "Opt-in alone is not enough if bedroom-hour audio is still ingested wholesale. Add filters and review before training use.",
        "lenses": [
          "non-maleficence",
          "virtue"
        ],
      ...
      "outcome-proceed-speaker": {
        ...
        "rationale": "Clear opt-in, visible indicators, short retention, and sensitive-context filters make a constrained improvement program defensible.",
        "lenses": [
          "utilitarian",
          "accountability"
        ],
  ...
  "kids-edu-app": {
    ...
    "context": "A math app for ages 8\u201312 collects gameplay timing and mistake patterns 'to personalize lessons.' Partnerships now proposes selling aggregated-but-fine-grained classroom engagement stats to toy brands for targeted ads. Parents consented only to educational personalization.",
    "bookAnchors": [
      "\u00a73.9",
      "sec:3.9"
    ],
    ...
    "nodes": {
      ...
      "outcome-stop-child": {
        ...
        "rationale": "Downplaying children's data as 'ordinary metrics' fails non-maleficence and justice. Raise the protection level before any commercial reuse.",
        "lenses": [
          "non-maleficence",
          "justice"
        ],
      ...
      "outcome-stop-ads": {
        ...
        "rationale": "Parents consented to lessons, not toy ads. Stretching personalization to cover advertiser sales fails purpose limitation and autonomy.",
        "lenses": [
          "purpose-limitation",
          "autonomy"
        ],
      ...
      "outcome-revise-kids": {
        ...
        "rationale": "If ads are ever considered, they need an affirmative parent opt-in that is not bundled with schooling features\u2014and many ethics reviews will still say no.",
        "lenses": [
          "autonomy",
          "virtue"
        ],
      ...
      "outcome-proceed-kids": {
        ...
        "rationale": "Keeping analytics inside the educational purpose and funding without targeting kids is the ethically safer path.",
        "lenses": [
          "non-maleficence",
          "utilitarian"
        ],
  ...
  "insurance-telematics": {
    ...
    "context": "A usage-based insurance program offers a discount for installing a tracking app. Fine print allows selling 'de-identified driving insights' to city planners and raising rates after inferred late-night trips through certain ZIP codes.",
    "bookAnchors": [
      "\u00a73.9",
      "sec:3.9"
    ],
    ...
    "nodes": {
      ...
      "outcome-stop-vol": {
        ...
        "rationale": "If the only affordable plan requires continuous tracking, consent is not freely given. Rights-based and justice lenses reject that design.",
        "lenses": [
          "rights-based",
          "justice"
        ],
      ...
      "outcome-stop-proxy": {
        ...
        "rationale": "'Any correlate' invites discriminatory or neighborhood-based penalties dressed up as risk science.",
        "lenses": [
          "justice",
          "non-maleficence"
        ],
      ...
      "outcome-revise-ins": {
        ...
        "rationale": "Drivers may accept safety discounts without agreeing to commercial resale. Split the choices and minimize shared fields.",
        "lenses": [
          "autonomy",
          "purpose-limitation"
        ],
      ...
      "outcome-proceed-ins": {
        ...
        "rationale": "Voluntary enrollment, proxy audits, and unbundled resale make a narrower program more defensible\u2014with ongoing monitoring.",
        "lenses": [
          "utilitarian",
          "accountability"
        ],
  ...
  "employee-monitor": {
    ...
    "context": "A company proposes always-on keystroke logging and intermittent webcam 'attention' scoring for remote employees, used in performance reviews. Workers were hired under policies that mentioned only VPN and device encryption\u2014not continuous surveillance.",
    "bookAnchors": [
      "\u00a73.9",
      "sec:3.9"
    ],
    ...
    "nodes": {
      ...
      "outcome-stop-notice": {
        ...
        "rationale": "Changing to continuous scoring without clear prior notice fails transparency and respect for persons.",
        "lenses": [
          "transparency",
          "autonomy"
        ],
      ...
      "outcome-revise-need": {
        ...
        "rationale": "If deliverables and lighter audits work, continuous keystroke/webcam scoring is disproportionate.",
        "lenses": [
          "non-maleficence",
          "virtue"
        ],
      ...
      "outcome-stop-power": {
        ...
        "rationale": "When refusal risks pay or career, 'consent' is hollow. Justice and rights-based lenses reject automated score-driven punishment.",
        "lenses": [
          "justice",
          "rights-based"
        ],
      ...
      "outcome-proceed-emp": {
        ...
        "rationale": "Prior notice, necessity case, protected refusal, and human appeal before pay impact make a constrained program more defensible.",
        "lenses": [
          "accountability",
          "utilitarian"
        ],
  ...
  "cross-border": {
    ...
    "context": "A SaaS company serving EU customers proposes replicating personal data to a region with weaker privacy enforcement to cut storage cost. Marketing also wants local teams there to run experiments on the full customer table.",
    "bookAnchors": [
      "\u00a73.9",
      "\u00a73.10",
      "sec:3.9"
    ...
    "nodes": {
      ...
      "outcome-stop-basis": {
        ...
        "rationale": "Moving personal data to a weaker regime for savings without safeguards fails accountability and rights-based duties to customers.",
        "lenses": [
          "accountability",
          "rights-based"
        ],
      ...
      "outcome-revise-min": {
        ...
        "rationale": "'Experiments might need it' is not a reason to export the full table. Minimize fields and consider synthetic or aggregated alternatives.",
        "lenses": [
          "data-minimization",
          "purpose-limitation"
        ],
      ...
      "outcome-revise-access": {
        ...
        "rationale": "A lawful transfer can still become unethical if foreign teams freely repurpose customer data for growth experiments.",
        "lenses": [
          "purpose-limitation",
          "accountability"
        ],
      ...
      "outcome-proceed-border": {
        ...
        "rationale": "Documented basis, minimized fields, and tight logged access make a constrained cross-border replica more defensible.",
        "lenses": [
          "accountability",
          "utilitarian"
        ],
