...
**Live path:** `lectures/tools/text-augmentation/index.html` (after `build_site.py`)

For labeling exports, see [`../text-annotation/`](../text-annotation/).
For image transforms, see [`../image-augmentation/`](../image-augmentation/).
...
- Export `augmented-texts.json` / `.csv` plus a reproducible `generation-recipe`
